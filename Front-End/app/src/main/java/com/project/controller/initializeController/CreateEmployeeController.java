...
import com.project.view.initializationView.FinishSetUp;
...
public class CreateEmployeeController implements View.OnClickListener {

    private Context appContext;

    public CreateEmployeeController(Context context) {
    ...
    private void createAdmin(View view) {
        ...
        if (name.length() == 0) {
            ...
            Intent review = new Intent(this.appContext, FinishSetUp.class);
